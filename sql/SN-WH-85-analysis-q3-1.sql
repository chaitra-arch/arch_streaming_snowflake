...
FROM 
(--------
    select * from  {db_name}.{sc_name}.MONITOR_AND_ANALYS_WH_STEP_TWO --OPI_PRD.CMS_LOG_OPI.MONITOR_AND_ANALYS_WH_STEP_TWO --IDRC_SBX_IDROM.CMS_WORK_COMM_PRD.MONITOR_AND_ANALYS_WH_STEP_TWO
) mq
